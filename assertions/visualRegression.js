 ...
 */
var compareToBaseline = function(screenshotFile, callback, globalCallback){
 ...
 */
exports.assertion = function(selector, label, msg, gcallback) {
	var globalCallback = gcallback || function () {};
                ...
                if( selector ) {
                    this.saveScreenshot.call(this, path.join(options.currentFolder , file), function(){
                        cropElement.call(this, path.join(options.currentFolder , file), selector, function(){
                            compareToBaseline.call(this, file, callback, globalCallback);
                        });
                    });
                } else {
                    this.saveScreenshot.call(this, path.join(options.currentFolder , file), function(){
